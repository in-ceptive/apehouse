            ...
            <div className='container'>
              <div className='row m-10-hor'>
                <div className='col-12'>
                  <h1 className='text-center'>Mint an NFT
                  </h1>
                  <p>To mint an NFT, you first need to deploy a smart contract.
                  </p>
                  <p>Foundation contracts allow you to deploy best-in-class smart contracts that you own and can use across all of web3.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="col-lg-7 offset-lg-1 mb-5">
              <form id="form-create-item" className="form-border" action="#">
                <div className="field-set">
                  ...
                  <h5>Collection Symbol
                  </h5>
                  <textarea data-autoresize name="item_desc" id="item_desc" className="form-control" placeholder="e.g. 'APE'"></textarea>
