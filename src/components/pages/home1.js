  ...
  <div>
        ...
        <div className='row align-items-center'>
          <div className='col-lg-6'>
            ...
            <Reveal className='onStep' keyframes={fadeInUp} delay={0} duration={600} triggerOnce>
              <h6 className=""><span className="text-uppercase color">Apehouse</span></h6>
            </Reveal>
            ...
            <Reveal className='onStep' keyframes={fadeInUp} delay={600} duration={600} triggerOnce>
              <p className=" lead">
                ApeHouse is your gateway to buying, selling, and collecting digital masterpieces on ApeChain. Featuring top-tier artists and a thriving community of collectors, it’s more than just a marketplace—it’s where art, curation, and culture collide.
    ...
    <section className='container no-top'>
      <div className='row'>
        <div className='col-lg-6'>
          <div className='col-lg-6'>
            <h2 className='style-2'>Trending Artists
        ...
        <div className='col-lg-6'>
          <div className='col-lg-6'>
            <h2 className='style-2'>Top Collectors
