        ...
        <ol className="author_list">
            <li>
                ...
                <div className="author_list_info">
                    ...
                    <span className="bot">3.2 APE</span>
                </div>
            </li>
            <li>
                <div className="author_list_pp">
                ...
                <div className="author_list_info">
                    ...
                    <span className="bot">2.8 APE</span>
                </div>
            </li>
            <li>
                <div className="author_list_pp">
                ...
                <div className="author_list_info">
                    ...
                    <span className="bot">2.5 APE</span>
                </div>
            </li>
            <li>
                <div className="author_list_pp">
                ...
                <div className="author_list_info">
                    <span onClick={() => window.open("", "_self")}>Apehouse.art</span>
                    <span className="bot">2.2 APE</span>
                </div>
            </li>
            <li>
                <div className="author_list_pp">
                ...
                <div className="author_list_info">
                    ...
                    <span className="bot">1.9 APE</span>
                </div>
            </li>
            <li>
                <div className="author_list_pp">
                ...
                <div className="author_list_info">
                    ...
                    <span className="bot">1.6 APE</span>
                </div>
            </li>
            <li>
                <div className="author_list_pp">
                ...
                <div className="author_list_info">
                    ...
                    <span className="bot">1.5 APE</span>
                </div>
            </li>
            <li>
                <div className="author_list_pp">
                ...
                <div className="author_list_info">
                    ...
                    <span className="bot">1.3 APE</span>
                </div>
            </li>
            <li>
                <div className="author_list_pp">
                ...
                <div className="author_list_info">
                    ...
                    <span className='bot'>0.9 APE</span>
                </div>
            </li>
            <li>
                <div className="author_list_pp">
                ...
                <div className="author_list_info">
                    ...
                    <span className='bot'>0.8 APE</span>
                </div>
            </li>
            <li>
                <div className="author_list_pp">
                ...
                <div className="author_list_info">
                    ...
                    <span className='bot'>0.6 APE</span>
                </div>
            </li>
            <li>
                <div className="author_list_pp">
